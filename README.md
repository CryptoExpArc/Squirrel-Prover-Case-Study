...
i) Deal with the input message: `vector<string> split(string message)`<br>
...
Split depends on the reminder of decimal number `hash_value_24`, ie: `dec_after_S_box_bit%2`<br>
...
The partial output of Q2 c++ code:<br>
total test: 10000<br>
